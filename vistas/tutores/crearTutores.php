...
<!DOCTYPE html>
<html lang="es"><!--Código temporal en lo que se coloca el de la historia de usuario 2-->
<head>
  <meta charset="UTF-8">
    ...
    <form method="POST" action="<?= BASE_URL ?>/index.php?modulo=tutores&accion=crear">
      ...
      <div class="grupo-formulario">
        ...
        <input type="text" name="apellido" id="apellido" required 
               placeholder="Ej: Campos" maxlength="80"
      ...
      <div class="grupo-formulario">
        ...
        <input type="email" name="email" id="email" required 
               placeholder="Ej: juan.campos@ejemplo.com" maxlength="120"
